...
def create_assistant():
    ...
    - To respond to user queries by referencing specific parts of the manual, using the timestamps to provide context.
...
def main():
    try:
        ...
        print("Hello there, write anything to start the interaction. \n")

        keep_asking = True
        while keep_asking:
            user_question = input()
            create_message(thread['id'], user_question)
            ...
            # continue_asking = input("Do you want to ask another question? (yes/no) ").lower()
            # keep_asking = continue_asking == 'yes'

            # if not keep_asking:
            #    print("Alrighty then, I hope you learned something!\n")
